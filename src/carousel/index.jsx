...
const Carousel = ({ children }) => {
    ...
    return (
        <div>
            <ul onMouseDown={mouseDownHandler} onMouseUp={mouseUpHandler} ref={carouselRef} onMouseMove={mouseMoveHandler} className="carousel" style={{ cursor: isGrabbing && "grab", scrollSnapType:isGrabbing && "none" }}>
